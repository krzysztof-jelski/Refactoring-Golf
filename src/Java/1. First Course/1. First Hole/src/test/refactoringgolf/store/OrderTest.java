...
public class OrderTest {
	...
	public void holdManyOrderItems() {
		...
		OrderItem orderItem = createOrderItem(10, Product.ACCESSORIES, 1);
	...
	public void returnTheTotalWithAccessoriesDiscount() {
		...
		OrderItem orderItem = createOrderItem(50, Product.ACCESSORIES, 2);
		addItemToOrder(order, orderItem);
	...
	public void returnTheTotalWithBikesDiscount() {
		Order order = createOrder("USA");
		OrderItem orderItem = createOrderItem(200, Product.BIKES, 2);
		addItemToOrder(order, orderItem);
	...
	private OrderItem createOrderItem(int unitPrice, String productCategory, int quantity) {
